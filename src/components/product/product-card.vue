...
<template>
  <div class="flex flex-col rounded-xl bg-white p-3 shadow transition hover:shadow-md">
    <div class="relative">
      <img
        ...
        loading="lazy"
      />
      <div v-else class="flex h-40 w-full items-center justify-center rounded-md bg-gray-100 text-gray-400">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" viewBox="0 0 24 24" fill="currentColor">
          <path d="M21 19V5a2 2 0 0 0-2-2H5c-1.1 0-2 .9-2 2v14l2-2h14l2 2zM8.5 13.5l2.5 3 3.5-4.5 4.5 6H5l3.5-4.5z"/>
        </svg>
      </div>
      ...
      >
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M9 3h6a1 1 0 0 1 1 1v1h4v2h-1v12a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V7H4V5h4V4a1 1 0 0 1 1-1zm8 4H7v12h10V7zM9 9h2v8H9V9zm4 0h2v8h-2V9z"/>
        </svg>
      </button>
    </div>
